...
var CurrArticleContent = function CurrArticleContent(props) {
  var relatedArticles = props.currTopic.filter(function (post) {
    return post.id != props.currArticle.id;
  });
  return __jsx("div", {
    __source: {
      fileName: _jsxFileName,
    ...
    src: "../../static/assets/template/".concat(props.currArticle.image),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 33
    },
    ...
    className: "container text-left py-3",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 42
    },
...
var PostContent = function PostContent(props) {
  ...
  var currArticleWebName = props.currArticleWebName;
  console.log(currArticleWebName); // we get the aritcle name to display here
  ...
  console.log(currArticle[0].po);
  var currTopic = _static_postContent_json__WEBPACK_IMPORTED_MODULE_3__.filter(function (post) {
    return post.postName == currArticle.postName;
...
//# sourceMappingURL=[article].js.78bc1233bb8c81734d0b.hot-update.js.map