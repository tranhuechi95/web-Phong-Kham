...
var MainTopicArticle = function MainTopicArticle(props) {
  ...
  console.log("postContent: " + props.postContent);
  console.log("currPostName: " + props.currPostName);
  var currTopicPost = props.postContent.filter(function (article) {
    return article.postName == props.currPostName;
  });
  console.log("currTopicPost: " + currTopicPost);
  var filteringId = currTopicPost[0].id; // filter out the 1st article

  var otherArticles = currTopicPost.filter(function (article) {
    return article.id != filteringId;
  });
  return __jsx("div", {
    __source: {
      fileName: _jsxFileName,
    ...
    __self: this
  }, currTopicPost[0].excerpt)), __jsx("hr", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 50
    },
...
//# sourceMappingURL=[postName].js.ca2297fa7a07bbf0d58b.hot-update.js.map