...
var OtherTopic = function OtherTopic(props) {
  var otherTopics = props.posts.filter(function (post) {
    return post.postName != props.currLinkName;
  });
  return __jsx("div", {
    __source: {
    ...
    return __jsx("h1", {
      ...
      __self: this
    }, "This is topic ", topic.name);
  }));
};

var Post = function Post() {
  var router = Object(next_router__WEBPACK_IMPORTED_MODULE_2__["useRouter"])();
  var currPostName = router.query.postName; // how do I get the name of this link name?
...
//# sourceMappingURL=[postName].js.64e5040da3ec0c8eadc1.hot-update.js.map