...
var MainTopicArticle = function MainTopicArticle(props) {
  ...
  console.log(currTopicPost); //const filteringId = currTopicPost[0].id;
  // filter out the 1st article

  var otherArticles = props.postContent.filter(function (article) {
    return article.postName == props.currPostName;
  });
  currTopicPost.filter(function (article) {
...
//# sourceMappingURL=[postName].js.fd57293bb8513d053a2c.hot-update.js.map